...
#define MODULE_CELL_VOLTAGE_BASE         	0         // Volts
#define MODULE_CELL_VOLTAGE_FACTOR       	0.001     // Volts
#define MODULE_CELL_TOTAL_VOLTAGE_FACTOR 	0.015     // Volts
#define MODULE_CURRENT_BASE       			-655.36   // Amps
#define MODULE_CURRENT_FACTOR     			0.02      // Amps
#define MODULE_TEMPERATURE_BASE   			-55.35    // Degrees C
#define MODULE_TEMPERATURE_FACTOR 			0.01      // Degrees C
#define MODULE_PERCENTAGE_BASE      		0         // Percent
#define MODULE_PERCENTAGE_FACTOR    		0.5       // Percent
...
typedef struct {
  ...
  char        web4ComponentId[64];      // Generated Web4 component ID
  bool        web4Registered;           // Flag indicating Web4 registration status
}batteryModule;
