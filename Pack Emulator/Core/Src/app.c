...
void APP_Initialize(void)
{
  ...
  module[0].mmv             = (uint16_t)( 399  /MODULE_VOLTAGE_FACTOR);
  module[0].mmc             = (uint16_t)( 9  /MODULE_CURRENT_FACTOR - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR));
  module[0].state           = moduleOff;
  module[0].fwVersion       = 8200;
  module[0].hwVersion       = 1000;
  float maxChargeA          = ( 20/MODULE_CURRENT_FACTOR) - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR);
  module[0].maxChargeA      = (uint16_t) maxChargeA;
  float maxDischargeA       =  (-50/MODULE_CURRENT_FACTOR) - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR);
  module[0].maxDischargeA   = (uint16_t) maxDischargeA;
  module[0].maxChargeEndV   = (uint16_t)( 400/MODULE_VOLTAGE_FACTOR);
  ...
  module[0].soc             = (uint8_t) ( 90/PERCENTAGE_FACTOR);
  module[0].soh             = (uint8_t) ( 91/PERCENTAGE_FACTOR);
  ...
  module[1].mmv             = (uint16_t)( 398  /MODULE_VOLTAGE_FACTOR);
  module[1].mmc             = (uint16_t)( 8    /MODULE_CURRENT_FACTOR - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR));
  module[1].state           = moduleOff;
  module[1].fwVersion       = 8200;
  module[1].hwVersion       = 1000;
  maxChargeA                = ( 20/MODULE_CURRENT_FACTOR) - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR);
  module[1].maxChargeA      = (uint16_t) maxChargeA;
  maxDischargeA             = ( -20  /MODULE_CURRENT_FACTOR - (MODULE_CURRENT_BASE/MODULE_CURRENT_FACTOR));
  module[1].maxDischargeA   = (uint16_t) maxDischargeA;
  ...
  module[1].soc             = (uint8_t) ( 92   /PERCENTAGE_FACTOR);
  module[1].soh             = (uint8_t) ( 93   /PERCENTAGE_FACTOR);
...
void APP_TransmitCellZeroDetails(uint8_t index){
  ...
  memcpy(txd, &cellDetail, sizeof(cellDetail));
...
void APP_StateChange(void){
 ...
 if(moduleIndex != moduleCount){
   ...
   module[moduleIndex].hvBusVoltage = state.hvBusVoltage;


   sprintf(tempBuffer,"RX 0x514 State Change Request ID=%02x STATE=%02x HV=%.2fV",moduleId,state.state, state.hvBusVoltage * MODULE_VOLTAGE_FACTOR); serialOut(tempBuffer);
   // Transmit the 3 status frames
        APP_TransmitStatus1(moduleIndex);
        APP_TransmitStatus2(moduleIndex);
        APP_TransmitStatus3(moduleIndex);
